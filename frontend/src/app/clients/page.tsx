    ...
    <AppShell>
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <section className="card col-span-2 p-6">
          ...
          <table className="w-full text-left text-sm"><thead className="text-xs uppercase text-slate-400"><tr><th className="py-3">Organization</th><th>Contact</th><th>Location</th><th>Deals</th><th>Calls</th></tr></thead><tbody>
